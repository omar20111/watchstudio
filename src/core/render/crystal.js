/* Crystal renderer: dome or flat glass, highlights + AR coating tint.
...
export function drCrystal(ctx,o){const{crystalR,crystalH}=o.g;const r=crystalR;const W=ctx.canvas.width,H=ctx.canvas.height;
 const k=AR[o.finish]??.75, dome=o.variant==='dome';
 ...
 if(crystalH>0){const d=Math.min(.62,crystalH/(r*0.22));
