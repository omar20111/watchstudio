...
export function TopBar({onModal}){const s=useApp();
 ...
 const actions=[
  ...
  {tier:'wide',label:'Tech pack',icon:'⤓',run:()=>import('../export/techpack.js').then(m=>m.exportTechPack()),
   aria:'Export a tech pack for manufacturers: drawings, parts list and artwork',
   title:'Tech pack for a manufacturer: dimensioned drawings, parts list and dial, bezel and hands artwork (PDF + SVG, in a ZIP)'},
